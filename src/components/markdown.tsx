...
const components: Partial<Components> = {
  // @ts-expect-error: CodeBlock does not match the expected type for the 'code' component
  code: CodeBlock,
  ...
  a: ({ children, ...props }) => {
    return (
      // @ts-expect-error: Link component does not fully match the expected type for 'a' in ReactMarkdown
      <Link
